...
public class ChooseGameSceneController implements Initializable {
   ...
   @FXML
    ...
    void handleButtonAction(ActionEvent event) {
         try{
             FXMLLoader fxmlLoader1 = new FXMLLoader(getClass().getResource("gameName.fxml"));
           ...
           Logger.getLogger(ChooseGameSceneController.class.getName()).log(Level.SEVERE, null, ex);
       }
    }
    @Override
